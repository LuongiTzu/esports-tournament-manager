...
const extendedEn = {
  ...
  "teamDetail.navigation": "Team profile navigation",
  "teamDetail.rosterTab": "Roster",
  "teamDetail.matchesTab": "Matches",
  "teamDetail.infoTab": "Information",
  "teamDetail.about": "About the team",
  "teamDetail.noDescription": "This team has not added a description yet.",
  "teamDetail.startingRoster": "Starting roster",
  "teamDetail.substitutes": "Substitutes",
  "teamDetail.staff": "Coaching & management",
  "teamDetail.memberDetails": "Member information",
  "teamDetail.registeredOn": "Registered",
  "teamDetail.tournament": "Participating tournament",
  "teamDetail.visitTournament": "View tournament",
  "teamDetail.viewCompetition": "Schedule & results",
  "teamDetail.privateContact": "Contact information is only visible to authorized viewers.",
  "teamDetail.resultWin": "Victory",
  "teamDetail.resultLoss": "Defeat",
  "teamManage.readOnly": "Roster locked",
  "teamDetail.view": "View team profile →",
  "teamDetail.captain": "Captain / representative",
  "teamDetail.roster": "Team members",
  "teamDetail.gameId": "In-game ID",
  "teamDetail.stats": "Tournament performance",
  "teamDetail.statsHint": "This team's results in this tournament.",
  "teamDetail.played": "Played",
  "teamDetail.wins": "Wins",
  "teamDetail.draws": "Draws",
  ...
  "bracket.viewMode": "Match display mode",
  "bracket.winnerOf": "Winner of",
  ...
  "bracket.winnerPath": "Winner advances",
  "bracket.loserPath": "Loser route",
  "bracket.scheduledMatches": "Matches by round",
  "bracket.zoom": "Bracket zoom",
  "bracket.zoomOut": "Zoom out",
  "bracket.zoomIn": "Zoom in",
  "bracket.actualSize": "Actual size",
  ...
  "round.format.PLAYOFF": "Single Elimination",
  ...
  "tournament.detail.tournamentStarts": "Tournament starts",
  "tournament.detail.tournamentEnds": "Tournament ends",
  ...
  "team.register.manualTitle": "Add a team manually",
  "team.register.manualSubmit": "Add team to tournament",
  "team.register.invitedTitle": "Register an invited team",
  ...
  "tournament.create.systemManaged":
    "Organizer information and verification status are managed automatically by the system.",
  ...
  "lifecycle.publishVisibility": "Visibility after publishing",
  "lifecycle.publishRegistrationOpen":
    "Open team registration after publishing",
  "lifecycle.visibility": "Visibility",
  "lifecycle.makePrivate": "Make private",
  "lifecycle.makePublic": "Make public",
  "lifecycle.visibilityRule":
    "Changing visibility does not automatically open or close team registration.",
  "lifecycle.visibilityUpdated": "Tournament visibility updated.",
  "lifecycle.visibilityUpdateError": "Could not update tournament visibility.",
  "lifecycle.visibilityConfirm.PUBLIC":
    "Make this tournament public? Everyone will be able to find and view it; registration will not change.",
  "lifecycle.visibilityConfirm.PRIVATE":
    "Make this tournament private? Unrelated people will no longer find or view it; eligible teams keep access.",
  "invitation.previewError":
    "The invitation could not be loaded or is no longer valid.",
  "invitation.acceptError": "The invitation could not be accepted.",
  "invitation.eyebrow": "Private tournament invitation",
  "invitation.description": "You have been invited to join this tournament.",
  "invitation.game": "Game",
  "invitation.organizer": "Organizer",
  "invitation.expires": "Expires",
  "invitation.recipient": "Invited email",
  "invitation.signInHint":
    "Sign in or create an account with the invited email to continue.",
  "invitation.signIn": "Sign in",
  "invitation.createAccount": "Create account",
  "invitation.wrongAccount":
    "The current account does not match the invited email. Sign in with the correct account.",
  "invitation.registerTeam": "Continue team registration",
  "invitation.linkTeamPrefix": "Your account will be linked to",
  "invitation.linkAccountHint": "Confirm linking your account to the team.",
  "invitation.accept": "Accept invitation",
  "invitation.managementLoadError": "Could not load invitations.",
  "invitation.managementTitle": "Invite and add teams",
  "invitation.managementHint":
    "Invite a captain to register with an account or enter a team manually.",
  "invitation.addManualTeam": "Add team manually",
  "invitation.captainEmail": "Captain email",
  "invitation.sent": "Invitation sent.",
  "invitation.sendError": "Could not send the invitation.",
  "invitation.send": "Send invitation",
  "invitation.revokeConfirm": "Revoke this invitation?",
  "invitation.revoked": "Invitation revoked.",
  "invitation.revokeError": "Could not revoke the invitation.",
  "invitation.purpose": "Invitation type",
  "invitation.status": "Status",
  "invitation.actions": "Actions",
  "invitation.revoke": "Revoke",
  "invitation.empty": "No invitations yet.",
  "invitation.linkMember": "Invite account link",
  "invitation.purpose.TEAM_REGISTRATION": "Team registration",
  "invitation.purpose.TEAM_CLAIM": "Team ownership",
  "invitation.purpose.MEMBER_LINK": "Member account link",
  ...
  "admin.dashboard.description":
    "Track growth, competition activity, and issues requiring action across the platform.",
  "admin.dashboard.periodAria": "Growth period",
  "admin.dashboard.days": "days",
  "admin.dashboard.totalUsers": "Total users",
  "admin.dashboard.inLastPeriod": "in the last",
  "admin.dashboard.noPreviousData": "No previous data",
  "admin.dashboard.comparedPreviousPeriod": "Compared with the previous period",
  "admin.dashboard.ongoing": "Ongoing",
  "admin.dashboard.official": "Official",
  "admin.dashboard.totalMatches": "Total matches",
  "admin.dashboard.matchesToday": "matches today",
  "admin.dashboard.pendingReportCount": "Pending reports",
  "admin.dashboard.affectedTournaments": "affected tournaments",
  "admin.dashboard.reportedTournamentCount": "Tournaments with pending reports",
  "admin.dashboard.growthEyebrow": "Platform trends",
  "admin.dashboard.growthTitle": "Daily growth",
  "admin.dashboard.newUsers": "New users",
  "admin.dashboard.newTournamentsPeriod": "New tournaments",
  "admin.dashboard.usersSeries": "Users",
  "admin.dashboard.tournamentsSeries": "Tournaments",
  "admin.dashboard.growthChartAria":
    "Daily new users and new tournaments chart",
  "admin.dashboard.tournamentAnalysis": "Tournament composition",
  ...
  "admin.dashboard.recentTournaments": "Recent tournaments",
  "admin.dashboard.noRecentReports": "No reports yet.",
  "admin.dashboard.noRecentTournaments": "No tournaments yet.",
  "admin.dashboard.systemStatus": "System status",
  "admin.dashboard.managedRecords": "managed records",
  "admin.dashboard.quickAccess": "Quick access",
  "admin.dashboard.liveData": "Live data",
  "admin.dashboard.currentRatios": "Current ratios",
  "admin.dashboard.platformHealth": "Platform health",
  "admin.dashboard.activeAccounts": "Active accounts",
  "admin.dashboard.visibleTournaments": "Visible tournaments",
  "admin.dashboard.requiresAttention": "Requires attention",
  "admin.dashboard.attentionQueue": "Review queue",
  ...
  "admin.tournaments.filterLimitation":
    "Combine keyword, game, lifecycle, and moderation-status filters.",
  ...
  "admin.shell.sectionOverview": "Overview",
  "admin.shell.sectionManagement": "Management",
  "admin.shell.sectionSafety": "Safety & moderation",
  "admin.shell.systemOnline": "System operational",
  "admin.shell.viewWebsite": "View website",
