const extendedVi = {
  ...
  "ratings.update": "Cập nhật đánh giá",
  "ratings.count": "đánh giá",
  "ratings.yours": "Đánh giá của bạn",
  "ratings.hidden": "Đánh giá đang bị ẩn và không được tính điểm.",
  "ratings.delete": "Xóa đánh giá của tôi",
  "ratings.deleteConfirm": "Xóa đánh giá của bạn?",
  "ratings.saved": "Đã lưu thay đổi đánh giá.",
  "ratings.loadError": "Không tải được đánh giá.",
  "ratings.saveError": "Không lưu được đánh giá.",
  "ratings.refreshError":
    "Đã lưu nhưng chưa tải lại được dữ liệu. Bấm thử lại để cập nhật.",
  "ratings.empty": "Chưa có đánh giá để hiển thị.",
  "ratings.previous": "Trang trước",
  "ratings.next": "Trang sau",
  "ratings.moderation": "Kiểm duyệt đánh giá giải đấu",
  "ratings.filter": "Lọc trạng thái đánh giá",
  "ratings.all": "Tất cả",
  "ratings.visible": "Đang hiển thị",
  "ratings.hiddenLabel": "Đã ẩn",
  "ratings.hide": "Ẩn đánh giá",
  "ratings.restore": "Khôi phục đánh giá",
  "ratings.hideReason": "Nhập lý do ẩn đánh giá (bắt buộc).",
  "ratings.reasonLength": "Lý do không được quá 500 ký tự.",
  "ratings.restoreConfirm": "Khôi phục đánh giá và tính lại điểm tổng hợp?",
  "ratings.reason.ALLOWED": "Bạn đã có đánh giá cho giải này.",
  "ratings.reason.LOGIN_REQUIRED": "Đăng nhập để xem quyền đánh giá của bạn.",
  "ratings.reason.VERIFY_EMAIL": "Xác minh email trước khi đánh giá.",
  ...
  "teamDetail.navigation": "Điều hướng hồ sơ đội",
  "teamDetail.rosterTab": "Đội hình",
  "teamDetail.matchesTab": "Trận đấu",
  "teamDetail.infoTab": "Thông tin",
  "teamDetail.about": "Về đội tuyển",
  "teamDetail.noDescription": "Đội chưa cập nhật phần giới thiệu.",
  "teamDetail.startingRoster": "Đội hình chính",
  "teamDetail.substitutes": "Dự bị",
  "teamDetail.staff": "Ban huấn luyện & quản lý",
  "teamDetail.memberDetails": "Thông tin thành viên",
  "teamDetail.registeredOn": "Đăng ký",
  "teamDetail.tournament": "Giải đấu tham gia",
  "teamDetail.visitTournament": "Xem giải đấu",
  "teamDetail.viewCompetition": "Lịch đấu & kết quả",
  "teamDetail.privateContact": "Thông tin liên hệ chỉ hiển thị với người có quyền truy cập.",
  "teamDetail.resultWin": "Chiến thắng",
  "teamDetail.resultLoss": "Thất bại",
  "teamManage.readOnly": "Đội hình đã khóa",
  "teamDetail.view": "Xem hồ sơ đội →",
  "teamDetail.captain": "Đội trưởng / đại diện",
  "teamDetail.roster": "Thành viên đội",
  "teamDetail.gameId": "ID trong game",
  "teamDetail.stats": "Thành tích thi đấu",
  "teamDetail.statsHint": "Kết quả của đội trong giải đấu này.",
  "teamDetail.played": "Đã thi đấu",
  "teamDetail.wins": "Thắng",
  "teamDetail.draws": "Hòa",
  "teamDetail.losses": "Thua",
  "teamDetail.rank": "Hạng chung cuộc",
  "teamDetail.history": "Trận đấu gần đây",
  "teamDetail.historyHint": "Tối đa 10 trận đã hoàn thành gần nhất trong giải.",
  "teamDetail.noMembers": "Chưa có thông tin thành viên.",
  "teamDetail.noMatches": "Đội chưa có trận đấu hoàn thành.",
  "teamDetail.unknownTeam": "Chưa có thông tin đội",
  ...
  "bracket.viewMode": "Cách xem trận đấu",
  "bracket.winnerOf": "Đội thắng",
  "bracket.loserOf": "Đội thua",
  "bracket.resetFinal": "Chung kết reset",
  "bracket.ifNeeded": "Nếu cần",
  "bracket.resetCondition": "Chỉ đấu nếu đội nhánh thua thắng chung kết tổng",
  "bracket.bye": "Miễn đấu",
  "bracket.schedulePending": "Chưa có lịch",
  "bracket.finals": "Chung kết",
  "bracket.winnerPath": "Đội thắng đi tiếp",
  "bracket.loserPath": "Đường đội thua",
  "bracket.scheduledMatches": "Các trận theo lượt",
  "bracket.zoom": "Kích thước sơ đồ",
  "bracket.zoomOut": "Thu nhỏ",
  "bracket.zoomIn": "Phóng to",
  "bracket.actualSize": "Kích thước gốc",
  ...
  "bracket.swissQualified": "Đi tiếp",
  "bracket.swissPendingHint": "Cặp đấu được xác định sau lượt trước",
  "bracket.swissWinPath": "Sau trận thắng",
  "bracket.swissLossPath": "Sau trận thua",
  "bracket.stageLabel": "Giai đoạn",
  ...
  "tournament.detail.tournamentStarts": "Bắt đầu thi đấu",
  "tournament.detail.tournamentEnds": "Kết thúc thi đấu",
  ...
  "team.register.manualTitle": "Thêm đội thủ công",
  "team.register.manualSubmit": "Thêm đội vào giải",
  "team.register.invitedTitle": "Đăng ký đội theo lời mời",
  ...
  "tournament.create.systemManaged":
    "Thông tin người tổ chức và trạng thái xác minh được hệ thống tự động quản lý.",
  ...
  "lifecycle.publishVisibility": "Chế độ hiển thị sau khi công bố",
  "lifecycle.publishRegistrationOpen": "Mở nhận đăng ký ngay sau khi công bố",
  "lifecycle.visibility": "Quyền hiển thị",
  "lifecycle.makePrivate": "Chuyển sang riêng tư",
  "lifecycle.makePublic": "Chuyển sang công khai",
  "lifecycle.visibilityRule":
    "Thay đổi quyền hiển thị không tự động mở hoặc đóng đăng ký đội.",
  "lifecycle.visibilityUpdated": "Đã cập nhật quyền hiển thị giải đấu.",
  "lifecycle.visibilityUpdateError": "Không thể cập nhật quyền hiển thị.",
  "lifecycle.visibilityConfirm.PUBLIC":
    "Công khai giải đấu? Mọi người sẽ có thể tìm và xem giải; trạng thái đăng ký không thay đổi.",
  "lifecycle.visibilityConfirm.PRIVATE":
    "Chuyển giải sang riêng tư? Người ngoài sẽ không thể tìm hoặc xem giải; các đội hợp lệ vẫn giữ quyền truy cập.",
  "invitation.previewError":
    "Không thể tải lời mời hoặc lời mời không còn hiệu lực.",
  "invitation.acceptError": "Không thể chấp nhận lời mời.",
  "invitation.eyebrow": "Lời mời giải đấu riêng tư",
  "invitation.description": "Bạn đã được mời tham gia giải đấu này.",
  "invitation.game": "Trò chơi",
  "invitation.organizer": "Ban tổ chức",
  "invitation.expires": "Hết hạn",
  "invitation.recipient": "Email nhận lời mời",
  "invitation.signInHint":
    "Đăng nhập hoặc tạo tài khoản bằng đúng email nhận lời mời để tiếp tục.",
  "invitation.signIn": "Đăng nhập",
  "invitation.createAccount": "Tạo tài khoản",
  "invitation.wrongAccount":
    "Tài khoản hiện tại không trùng với email nhận lời mời. Vui lòng đăng nhập bằng đúng tài khoản.",
  "invitation.registerTeam": "Tiếp tục đăng ký đội",
  "invitation.linkTeamPrefix": "Tài khoản sẽ được liên kết với đội",
  "invitation.linkAccountHint": "Xác nhận liên kết tài khoản với đội.",
  "invitation.accept": "Chấp nhận lời mời",
  "invitation.managementLoadError": "Không tải được danh sách lời mời.",
  "invitation.managementTitle": "Mời và thêm đội",
  "invitation.managementHint":
    "Mời đội trưởng đăng ký bằng tài khoản hoặc nhập một đội thủ công.",
  "invitation.addManualTeam": "Thêm đội thủ công",
  "invitation.captainEmail": "Email đội trưởng",
  "invitation.sent": "Đã gửi lời mời.",
  "invitation.sendError": "Không thể gửi lời mời.",
  "invitation.send": "Gửi lời mời",
  "invitation.revokeConfirm": "Thu hồi lời mời này?",
  "invitation.revoked": "Đã thu hồi lời mời.",
  "invitation.revokeError": "Không thể thu hồi lời mời.",
  "invitation.purpose": "Loại lời mời",
  "invitation.status": "Trạng thái",
  "invitation.actions": "Thao tác",
  "invitation.revoke": "Thu hồi",
  "invitation.empty": "Chưa có lời mời nào.",
  "invitation.linkMember": "Mời liên kết tài khoản",
  "invitation.purpose.TEAM_REGISTRATION": "Đăng ký đội",
  "invitation.purpose.TEAM_CLAIM": "Nhận quyền đội",
  "invitation.purpose.MEMBER_LINK": "Liên kết thành viên",
  "invitation.status.PENDING": "Đang chờ",
  "invitation.status.ACCEPTED": "Đã chấp nhận",
  "invitation.status.REVOKED": "Đã thu hồi",
  "invitation.status.EXPIRED": "Đã hết hạn",
  ...
  "admin.dashboard.description":
    "Theo dõi tăng trưởng, hoạt động thi đấu và các vấn đề cần xử lý trên toàn nền tảng.",
  "admin.dashboard.periodAria": "Khoảng tăng trưởng",
  "admin.dashboard.days": "ngày",
  "admin.dashboard.totalUsers": "Tổng người dùng",
  "admin.dashboard.inLastPeriod": "trong",
  "admin.dashboard.noPreviousData": "Chưa có kỳ trước",
  "admin.dashboard.comparedPreviousPeriod": "So với kỳ trước",
  "admin.dashboard.ongoing": "Đang diễn ra",
  "admin.dashboard.official": "Official",
  "admin.dashboard.totalMatches": "Tổng trận đấu",
  "admin.dashboard.matchesToday": "trận hôm nay",
  "admin.dashboard.pendingReportCount": "Báo cáo đang chờ xử lý",
  "admin.dashboard.affectedTournaments": "giải đấu bị ảnh hưởng",
  "admin.dashboard.reportedTournamentCount": "Giải có báo cáo đang chờ",
  "admin.dashboard.growthEyebrow": "Xu hướng nền tảng",
  "admin.dashboard.growthTitle": "Tăng trưởng theo ngày",
  "admin.dashboard.newUsers": "Người dùng mới",
  "admin.dashboard.newTournamentsPeriod": "Giải đấu mới",
  "admin.dashboard.usersSeries": "Người dùng",
  "admin.dashboard.tournamentsSeries": "Giải đấu",
  "admin.dashboard.growthChartAria":
    "Biểu đồ người dùng mới và giải đấu mới theo ngày",
  "admin.dashboard.tournamentAnalysis": "Cơ cấu giải đấu",
  ...
  "admin.dashboard.recentReports": "Báo cáo gần đây",
  "admin.dashboard.recentTournaments": "Giải đấu gần đây",
  "admin.dashboard.noRecentReports": "Chưa có báo cáo nào.",
  "admin.dashboard.noRecentTournaments": "Chưa có giải đấu nào.",
  "admin.dashboard.systemStatus": "Trạng thái hệ thống",
  "admin.dashboard.managedRecords": "bản ghi đang quản lý",
  "admin.dashboard.quickAccess": "Truy cập nhanh",
  "admin.dashboard.liveData": "Dữ liệu trực tiếp",
  "admin.dashboard.currentRatios": "Tỷ lệ hiện tại",
  "admin.dashboard.platformHealth": "Sức khỏe nền tảng",
  "admin.dashboard.activeAccounts": "Tài khoản đang hoạt động",
  "admin.dashboard.visibleTournaments": "Giải đang hiển thị",
  "admin.dashboard.requiresAttention": "Cần chú ý",
  "admin.dashboard.attentionQueue": "Hàng đợi xử lý",
  ...
  "admin.tournaments.emptyHint":
    "Hãy thử thay đổi hoặc xóa các bộ lọc hiện tại.",
  ...
  "admin.tournaments.filterLimitation":
    "Có thể kết hợp từ khóa, trò chơi, vòng đời và trạng thái kiểm duyệt.",
  ...
  "admin.shell.sectionOverview": "Tổng quan",
  "admin.shell.sectionManagement": "Quản lý",
  "admin.shell.sectionSafety": "An toàn & kiểm duyệt",
  "admin.shell.systemOnline": "Hệ thống hoạt động",
  "admin.shell.viewWebsite": "Xem website",
