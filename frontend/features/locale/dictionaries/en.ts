...
const en = {
  ...
  "home.formats.ROUND_ROBIN.description": "Every team faces the others to build a complete ranking table.",
  "home.formats.GROUP_STAGE.label": "Group stage",
  "home.formats.GROUP_STAGE.description": "Split teams into groups before selecting who advances according to the round configuration.",
  "home.formats.SWISS.label": "Swiss system",
  "home.formats.SWISS.description": "Pair teams with similar records over multiple rounds.",
  "home.formats.PLAYOFF.label": "Playoff",
  "home.formats.PLAYOFF.description": "Use direct elimination to find the last team standing.",
  "home.formats.DOUBLE_ELIM.label": "Double elimination",
  "home.formats.DOUBLE_ELIM.description": "Maintain upper and lower brackets to give teams another chance to compete.",
