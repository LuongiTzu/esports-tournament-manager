...
export const inputClass =
  "min-h-[var(--control-height)] w-full rounded-[var(--radius-control)] border border-line bg-surface-sub px-4 py-3 text-sm text-ink placeholder:text-ink-faint outline-none transition-[border-color,box-shadow,background-color] duration-200 hover:border-line-strong focus:border-brand-hover focus:bg-surface-card focus:shadow-[var(--shadow-focus)] disabled:cursor-not-allowed disabled:opacity-55";
...
export const primaryButtonClass =
  "inline-flex min-h-[var(--control-height)] items-center justify-center gap-2 rounded-[var(--radius-control)] bg-gradient-brand px-6 py-3 text-sm font-semibold text-on-brand shadow-[var(--shadow-button)] transition-[transform,filter,box-shadow] duration-200 hover:-translate-y-0.5 hover:brightness-110 hover:shadow-glow-brand active:translate-y-0 active:scale-[0.98] disabled:cursor-not-allowed disabled:translate-y-0 disabled:opacity-50";

export const secondaryButtonClass =
  "inline-flex min-h-[var(--control-height)] items-center justify-center gap-2 rounded-[var(--radius-control)] border border-line-strong bg-surface-sub px-5 py-3 text-sm font-semibold text-ink transition-[transform,border-color,background-color,box-shadow] duration-200 hover:-translate-y-0.5 hover:border-brand/70 hover:bg-surface-hover hover:shadow-[var(--shadow-focus)] active:translate-y-0 active:scale-[0.98] disabled:cursor-not-allowed disabled:translate-y-0 disabled:opacity-50";

export const ghostButtonClass =
  "inline-flex min-h-10 items-center justify-center gap-2 rounded-[var(--radius-control)] px-3.5 py-2 text-sm font-medium text-ink-muted transition-colors duration-200 hover:bg-white/5 hover:text-ink focus-visible:outline-none focus-visible:shadow-[var(--shadow-focus)]";
